...
- **Localization**: Chinese language support for UI and documentation
...
This project provides Chinese language support:
- **Chinese Documentation**: [README_CN.md](Version2.0/README_CN.md)
- **Chinese User Manual**: [USER_MANUAL_CN.md](Version2.0/docs/USER_MANUAL_CN.md)
- **Chinese Build Guide**: [BUILD_GUIDE_CN.md](Version2.0/docs/BUILD_GUIDE_CN.md)
- **Chinese Troubleshooting**: [BACKEND_FIX_CN.md](Version2.0/docs/BACKEND_FIX_CN.md)
- **Chinese Quick Start**: [QUICKSTART_CN.md](Version2.0/QUICKSTART_CN.md)
- **Chinese Sample Data**: Located in the `Version2.0/data/` directory
...
│   ├── data/             # Sample data (English and Chinese)
│   ├── docs/             # Documentation
